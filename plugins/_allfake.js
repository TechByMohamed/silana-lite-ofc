...
handler.all = async function (m) {
  ...
  let fotonyu = "https://files.catbox.moe/s3aubk.png";
  let logo = "https://files.catbox.moe/s3aubk.png"; // define logo aquí
  let namebot = "RifGhos LITE AI";
  let sig = "https://www.instagram.com/m.tech99";
  ...
  try {
    ...
    global.emror = "https://files.catbox.moe/s3aubk.png";
    ...
    global.kontak2 = [
      [
        owner[0],
        await conn.getName(owner[0] + "212654340082@s.whatsapp.net"),
        "RifGhos AI",
        "https://whatsapp.com",
        true,
      ],
    ...
    global.adReply = {
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: "120363344347887741@newsletter",
          serverMessageId: 103,
          newsletterName: `RifGhos LITE AI    |   هيا نحو النجاح 🧑‍🏫`,
        },
        externalAdReply: {
          title: namebot,
          body: global.ucapan,
